...
#if !WINDOWS_UWP
		protected WebRequestException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context) { }
#endif
	}
    ...
    public static class WebServer
    {
        ...
        static void ProcessRequest(HttpListenerContext context)
        {
            ...
            try
            {
                ...
                {
                    path = Path.Combine(WebServer.Unity, UnityWebRequest.UnEscapeURL(url.PathAndQuery.Substring(1)));
                }
                else
                {
                    path = Path.Combine(WebServer.Root, UnityWebRequest.UnEscapeURL(url.PathAndQuery.Substring(1)));
                }
